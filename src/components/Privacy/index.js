...
const PrivacySection = ({
    ...
    return (
        <>
            <TextWrapper>
                <H1>Telie Privacy Policy</H1>
                <H2>Privacy Policy of Telie</H2>
                <Text>
                ...
                <Text>
                    Telie (owner) will not provide a comprehensive list
                ...
                <Text>
                    The types of data collected by Telie include, but
                ...
                <Text>Telie does not use cookies.</Text>
                ...
                <Text>
                    Telie does not guarantee or secure retention times
                ...
                <Text>
                    Telie reserves the right to update and modify this
                ...
                <H3>User</H3>
                <Text>
                    The individual using the application (Telie).
                        </Text>
                <H3>Data Controller (or Owner)</H3>
                <Text>
                    Telie application and all team members who retain
                ...
                <Text>
                    Telie, its members, and the Application Owner(s) are
